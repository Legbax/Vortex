...
def main():
    with sync_playwright() as p:
        ...
        # The button contains text "device", so get_by_role('button', name='device') works
        # But name might match the icon too if it has aria-label?
        # The button has text 'device' in a span.
